...
- [x] Task 6: Deliver Capture, notes, revisions, search, graph, reminders, attachments, and diagnostics.
  ...
  - [x] Task 6B: Add folders, tags, links, reminders, graph, FTS search documents, and saved-search filters.
    ...
    - [x] Task 6B.2: Add folder/tag assignment, note links, reminders, and global/local graph APIs.
...
- [x] Task 12: Prepare preview readiness, backup/restore evidence, cutover checklist, and rollback evidence; stop before production actions.
